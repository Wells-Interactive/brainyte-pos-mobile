...
class BarDashboardScreen extends StatefulWidget {
  ...
  @override
  State<BarDashboardScreen> createState() => _BarDashboardScreenState();
}
              ...
              ? const Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 16),
                      Text('All drink orders completed', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
                      SizedBox(height: 8),
